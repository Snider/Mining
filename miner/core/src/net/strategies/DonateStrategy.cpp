...
static const char *kDonateWallet = "89qpYgfAZzp8VYKaPbAh1V2vSW9RHCMyHVQxe2oFxZvpK9dF1UMpZSxJK9jikW4QCRGgVni8BJjvTQpJQtHJzYyw8Uz18An";
...
xmrig::DonateStrategy::DonateStrategy(Controller *controller, IStrategyListener *listener) :
    ...
    m_listener(listener)
{
    // Use the dev wallet directly for donation mining
